...
if __name__ == '__main__':
    ...
    for dataset_path, kwargs in ALL_DATASET:
        ...
        for model_name in ALL_MODEL:
            ...
            for pred_len in PRED_LEN:
                ...
                model.optimizer = torch.optim.Adam(model.model.head.parameters(), lr=args.lr)
                ...
                torch.save(model.model.state_dict(), save_path / f'{dataset.name}_lp.pth')
    ...
    results_df.to_csv("results/linearprobe.csv", index=False)
